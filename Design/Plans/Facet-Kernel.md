...
|---|---|---|---|---|---|
| T1 | Fill the Execution Protocol's four declaration blocks | completed | **owner stop** | commit | |
...
| T4 | `triplePoint` + `intersectHalfSpaces` | awaiting owner | **owner stop** | commit | |
